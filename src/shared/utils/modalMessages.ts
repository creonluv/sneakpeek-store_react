...
const ModalMessages: Record<messages, { title: string; description: string }> =
  {
    ...
    [RegisterPageMessages.REGISTER_SUCCESS]: {
      ...
      description:
        "Registration was successful. Redirecting to the homepage...",
    },
    ...
    [ProfilePageMessages.PROFILE_IMAGE_ERROR]: {
      ...
      description:
        "There was an issue updating your profile image. Please try again.",
    },
    ...
    [ProfilePageMessages.ALL_FIELDS_REQUIRED]: {
      title: "Fields Required",
      description:
        "All fields are required. Please fill out all fields before proceeding.",
    },
    [ProfilePageMessages.INVALID_PASSWORD_CONFIRMATION]: {
      title: "Password Confirmation Error",
      description:
        "New password and confirmation do not match. Please try again.",
    },
    [ProfilePageMessages.CHANGE_PASSWORD_ERROR]: {
      title: "Password Change Error",
      description:
        "There was an error changing your password. Please try again.",
    },
    [ProfilePageMessages.CHANGE_PASSWORD_SUCCESS]: {
    ...
    [FavouritePageMessages.DELETE_FAVOURITE_SUCCESS]: {
      ...
      description:
        "The item has been successfully removed from your favourites.",
    },
    ...
    [BucketPageMessages.DELETE_BUCKET_ERROR]: {
      ...
      description:
        "Failed to delete item from the shopping bucket. Please try again.",
    },
